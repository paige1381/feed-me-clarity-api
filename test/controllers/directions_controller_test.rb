...
class DirectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create direction" do
    assert_difference('Direction.count') do
      post directions_url, params: { direction: { direction: @direction.direction } }, as: :json
    end
  ...
  test "should update direction" do
    patch direction_url(@direction), params: { direction: { direction: @direction.direction } }, as: :json
    assert_response 200
  end
